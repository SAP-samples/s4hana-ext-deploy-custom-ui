sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("sap/ui/equipment/EquipmentCRUD/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#EquipmentCRUD-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#EquipmentCRUD-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("sap.ui.equipment.EquipmentCRUD.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["sap/ui/equipment/EquipmentCRUD/localService/mockserver"], function (mockserver) {
