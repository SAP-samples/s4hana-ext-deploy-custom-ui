		...
		onTheMasterPage: {
			...
			actions: {
				...
				iRememberTheListItem: function (oListItem) {
					...
					this.getContext().currentItem = {
						...
						title: oBindingContext.getProperty("EquipmentNumber")
					};
				},
			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function () {
					return this.waitFor({
						...
						matchers: new PropertyStrictEquals({
							name: "title",
							value: "YY1_EQUIPMENT (0)"
						}),
						success: function () {
							Opa5.assert.ok(true, "The list header displays 'YY1_EQUIPMENT (0)'");
						},
				...
				theListShouldBeSortedAscendingOnUnitNumber: function () {
					return this.theListShouldBeSortedAscendingOnField("PurchasePrice_V");
				},

				theListShouldBeSortedAscendingOnName: function () {
					return this.theListShouldBeSortedAscendingOnField("EquipmentNumber");
				},
				...
				theListShouldHaveAllEntries: function () {
					...
					// retrieve all YY1_EQUIPMENT to be able to check for the total amount
					...
					return this.waitFor({
						...
						success: function (oList) {
							...
							this.waitFor({
								...
								matchers: new PropertyStrictEquals({
									name: "title",
									value: "YY1_EQUIPMENT (" + iExpectedLength + ")"
								}),
								success: function () {
