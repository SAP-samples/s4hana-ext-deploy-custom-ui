sap.ui.define([
	...
	opaTest("MasterList Filtering on PurchasePrice_V less than 100", function (Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog("PurchasePrice_V").
	...
	opaTest("MasterList Filtering on PurchasePrice_V more than 100", function (Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog(">100 ").
		and.iPressOKInViewSelectionDialog();
